    ...
    <section className="welcome-section">
      <div className="welcome-info">
        ...
        <div className="welcome-text">
          ...
          <p>Hôm nay là một ngày tuyệt vời để tìm cơ hội mới cho bạn!</p>
          <div className="welcome-actions">
            <Link to="/candidate/profile/update" className="action-link">Xem hồ sơ</Link>
            <Link to="/candidate/profile/update" className="action-link">Cập nhật CV</Link>
            <Link to="/candidate/jobs" className="action-link">Tìm việc làm</Link>
          </div>
        </div>
      </div>
