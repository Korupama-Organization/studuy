  ...
  return (
    <section>
      <div className="section-header">
        ...
        <Link to="/candidate/jobs" className="view-all-link">
          Xem tất cả{" "}
      ...
      <div className="job-matches-grid">
          ...
          {jobs.length > 0 ? (
              ...
              <div key={job.jobId} className="job-card">
                ...
                <div className="job-info">
                  ...
                  <div className="job-actions">
                    <Link to="/candidate/jobs" className="btn-primary" style={{ textDecoration: "none" }}>
                      Ứng tuyển ngay
                    </Link>
                    <button className="btn-outline" type="button">Lưu</button>
                  </div>
                </div>
              </div>
            ))
            ...
            >
              ...
              <p style={{ margin: 0 }}>
                ...
                <br />
                Hãy <Link to="/candidate/profile/update" style={{ color: "#6366f1", fontWeight: 600 }}>cập nhật hồ sơ</Link> để hệ thống đề xuất tốt hơn.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="promo-cards">
          <div className="promo-card">
            ...
            <Link to="/candidate/jobs" className="btn-white">
              Xem tất cả việc làm
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <line x1="5" y1="12" x2="19" y2="12" />
                <polyline points="12 5 19 12 12 19" />
          ...
          <div className="score-card">
            ...
            <div className="score-bar-bg">
              <div className="score-bar-fill" style={{ width: `${clampedOverallScore}%` }} />
            </div>
            <p style={{ fontSize: "0.75rem", marginTop: "0.75rem", opacity: 0.8, marginBottom: 0 }}>
              {clampedOverallScore >= 80
                ? "Hồ sơ của bạn rất ấn tượng! 🎉"
                : clampedOverallScore >= 50
