  ...
  return (
    <header className="rd-topbar">
      ...
      <div className="rd-topbar-right">
        ...
        <button
          type="button"
          className={`rd-topbar-notifications${isActivityPanelOpen ? " active" : ""}`}
          aria-label={isActivityPanelOpen ? "Đóng bảng thông báo" : "Mở bảng thông báo"}
          aria-expanded={isActivityPanelOpen}
          onClick={onToggleActivityPanel}
        >
          {notificationCount > 0 ? <span className="rd-notif-dot" /> : null}
