...
const roleOptions = ["recruiter", "hr_manager", "admin", "interviewer"];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="flex w-full max-w-md flex-col gap-6 rounded-2xl bg-white p-6 shadow-lg">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="mb-3 text-sm font-semibold text-slate-500">Role</h3>
            <div className="space-y-3">
              {roleOptions.map((role) => (
                <div
                  ...
                  <span className="text-sm capitalize text-slate-700">{role.replace("_", " ")}</span>
                </div>
              ))}
            </div>
          </div>
